class Local:
    def __init__(self, nome, tipo, raridade, bonus, emoji):
        self.nome = nome
        self.tipo = tipo
        self.raridade = raridade
        self.bonus = bonus
        self.emoji = emoji
        self.nome_personalizado = self.gerar_nome_personalizado()
    ...
    def gerar_nome_personalizado(self):
        if self.raridade == "comum":
            cor = "#00ff33"
        elif self.raridade == "incomum":
            cor = "#00cdff"
        ...
        return f"[{cor}]{self.nome}[/{cor}]"
    
    def gerar_label(self):
        if self.raridade == "comum":
            return f"[italic]+ {self.bonus}[/italic]"
        elif self.raridade == "incomum":
            return f"[italic]+ {self.bonus}[/italic]"
        elif self.raridade == "raro":
            return f"[italic]+ {self.bonus}[/italic]"
...
def gerar_local():
    ...
    emoji = tipos[raridade][categoria]['emoji']

    return Local(nome, categoria, raridade, bonus, emoji)
